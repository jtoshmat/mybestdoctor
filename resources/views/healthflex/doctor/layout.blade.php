                    ...
                    <div class="top_menu_container">
                        <ul id="menu-top-bar" class="top_menu hover_menu">
                            ...
                            <li id="menu-item-1775"
                                ...
                                <a title="Fees &amp; Insurance" href="/fees-insurance/">Fees &#038; Insurance</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav main-nav ml-auto">
                        <li class="menu-item mr-4"><a class="nav-link" title="About Us" href="/about-us/">About Us </a>
                        </li>
                        <li class="nav-item mr-4"><a class="nav-link" title="Careers" href="/careers/"> Careers </a>
                        </li>
                        <li class="menu-item mr-4"><a class="nav-link" title="Departments" href="/departments/">Departments</a>
                        </li>
                        <li id="menu-item-1771" class="menu-item mr-4"><a class="nav-link" title="Services"
                                                                          href="/services/">Services</a></li>
                        <li id="menu-item-1674" class="menu-item mr-4 has-submenu"><a class="nav-link" title="Info"
                                                                                      href="#">Info </a>
                            <ul role="menu" class="sub-menu">
                                <li><a class="nav-link" title="The Patient&#039;s &amp; Visitor&#039;s Guide"
                                       href="/visit-guide/">The Patient&#8217;s &#038; Visitor&#8217;s Guide</a></li>
                                <li id="menu-item-1767"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1767"><a
                                        class="nav-link" title="Appointment Booking" href="/appointment-booking/">Appointment
                                        Booking</a></li>
                                <li id="menu-item-1762"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1762"><a
                                        class="nav-link" title="Health Plans" href="/health-plans/">Health Plans</a>
                                </li>
                                <li id="menu-item-1761"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1761"><a
                                        class="nav-link" title="Health Library A-Z" href="/health-library/">Health
                                        Library A-Z</a></li>
                                <li id="menu-item-1756"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1756"><a
                                        class="nav-link" title="Fees &amp; Insurance" href="/fees-insurance/">Fees
                                        &#038; Insurance</a></li>
                                <li id="menu-item-1768"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1768"><a
                                        class="nav-link" title="FAQ" href="/faq/">FAQ</a></li>
                            </ul>
                        </li>
                    </ul>
                        ...
                        <div class="dashboard-widget">
                            <nav class="dashboard-menu">
                                <ul>
                                    ...
                                    <li class="{{ Request::path() ==='doctor/add-patient' ? 'active' : '' }}">
                                        <a href="{{ route('doctor.add-patient') }}">
                                            <i class="fas fa-user-injured"></i>
